...
*/
                                                                    ...
                                                                    <td width="156"
                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center"
                                                                                        class="esd-block-image es-m-txt-c es-p15b"
                                                                                        style="font-size: 0px;"><a
                                                                                            ...
                                                                                            href="${
                                                                                              process
                                                                                                ...
                                                                                                src="https://cdn-gujg.onrender.com/asset/logo/logo.png"
                                                                                                alt
                                                                                                style="display: block;"
                                                                                                height="60"></a></td>
                                                                                </tr>
                                ...
                                <tr>
                                    <td class="esd-stripe" align="center">
                                        <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p40t es-p30b es-p40r es-p40l es-m-p0b"
                                                        align="left">
    ...
    options.message_2 || ""
  }<br><br>${options.message_3 || ""}<br><br></p>
                                                                                        <p>Best regards,</p>
                                                                                        <p>${
                                                                                          process
                                                                                            .env
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p20t es-p40b es-p40r es-p40l"
                                                        align="left">
                                                        <!--[if mso]><table width="520" cellpadding="0" cellspacing="0"><tr><td width="95" valign="top"><![endif]-->
                                                        <table cellpadding="0" cellspacing="0" class="es-left"
                                                            align="left">
                                                            <tbody>
                                                                <tr>
                                                                    <td width="95" class="esd-container-frame"
                                                                        align="left">
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            width="100%">
                                                                            <tbody>
                                                        ...
                                                        <!--[if mso]></td><td width="20"></td><td width="405" valign="top"><![endif]-->
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left"
                                                                                        ...
                                                                                        <p><a target="_blank"
                                                                                                ...
                                                                                                style="text-decoration: underline; font-size: 14px;">contact@${
                                                                                                  process
                                                                                                    .env
                                                                                                    .URL
                                                                                                }</a>
